...
# create trackbars to change values real-time
...
while True:
    ...
    # get values from the trackbar, print to test
    ...
    # use the values to filter out and get image
    ...
    # stack images instead of showing seperately
    # cv2.imshow("Original",img)
    # cv2.imshow("HSV",imgHSV)
    # cv2.imshow("Mask",mask)
    # cv2.imshow("Result",imgResult)
    imgStack = stackImages(0.6, ([img, imgHSV], [mask, imgResult]))
    cv2.imshow("Stacked Videos", imgStack)
    cv2.waitKey(1)
